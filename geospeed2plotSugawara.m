function sum_res_squared = geospeed2plotSugawara(x2)
...
clear C; clear w; clear X1; clear we; clear D; clear t1; clear Temp; 
...
hold on
set(gca, 'fontsize', 12)
plot(t, TempC, 'b-', 'linewidth', 2.0, 'displayname', '2-stage model');
xlabel('Time (s)', 'fontsize', 12)
ylabel('Temperature (\circC)', 'fontsize', 12)
legend1 = legend(gca, 'show');
set(legend1,'Location','north', 'fontsize', 10);
legend
axis square
box on
...
subplot(2,2,2)
hold on;
plot(1000*X1(:,1),X1(:,3), 'b-', 'linewidth', 1.5, 'displayname', '2-stage model');
set(gca, 'FontSize', 12)
axis square
legend2 = legend(gca, 'show');
set(legend2,'Location','north', 'fontsize', 10);
axis square
box on
%plot(MgO(:,1), trialfit(8:7+length(MgO)),'o')
%plot(MgO(:,1),MgO(:,2), '+')
%title('Forward model tests');
%xlabel('r(mm)');
%ylabel('MgO(r,t)');
